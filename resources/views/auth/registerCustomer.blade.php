                    ...
                    <form method="POST" action="{{ route('registerCustomer') }}">
                        ...
                        @foreach($namearray as $table)
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="checkbox" id="{{$table}}" name="{{$table}}" value="create" style="margin-left:4%;"> Create
                                        <input type="checkbox" id="{{$table}}" name="{{$table}}" value="read" style="margin-left:4%;"> Read <br/>
                                        <input type="checkbox" id="{{$table}}" name="{{$table}}" value="update" style="margin-left:4%;"> Update
                                        <input type="checkbox" id="{{$table}}" name="{{$table}}" value="update" style="margin-left:4%;"> Delete
                                    </div>
                            </div>
                        @endforeach
